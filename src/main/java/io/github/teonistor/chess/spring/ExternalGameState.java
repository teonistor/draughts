...
public class ExternalGameState {
    public static final ExternalGameState NIL = new ExternalGameState(HashMap.empty(), List.empty(), List.empty(), HashMap.empty(), false, false);
    ...
    public ExternalGameState combine(final ExternalGameState other) {
        return new ExternalGameState(board, capturedPieces,
