...
class AsciiArtTest extends AnyFunSpec with IdiomaticMockito {
  ...
  describe("illustrateGame") {
    ...
    it("works") {
      ...
      withObjectMocked[AsciiArt.type] {
        ...
        AsciiArt.illustrateMines(bobBoard, aliceOpponentCursor, width, height) returns Vector(
          " ~~              ~~",
          " ~~ ~~        ~~ ~~",
          " ~~    ~~  ~~    ~~",
          " ~~      ~~      ~~",
          ...
          " ~~              ~~",
          " ~~              ~~")
        AsciiArt.illustrateShips(aliceBoard, aliceOverlay, aliceOwnCursor, width, height) returns Vector(
          "        X",
          "       XXX",
          "      XX XX",
          "     XX   XX",
          ...
          " XX           XX",
          "XX             XX")
        AsciiArt.illustrateInfo(aliceState) returns List("≈≈≈≈≈  ≈≈≈", "≈≈ ≈≈≈≈≈≈≈≈≈≈≈")
        AsciiArt.illustrateMines(aliceBoard, bobOpponentCursor, width, height) returns Vector(
          " ⋅⋅⋅      ⋅⋅⋅",
          " ⋅⋅ ⋅⋅  ⋅⋅ ⋅⋅",
          " ⋅⋅   ⋅⋅   ⋅⋅",
          " ⋅⋅   ⋅⋅   ⋅⋅",
          ...
          " ⋅⋅        ⋅⋅",
          " ⋅⋅        ⋅⋅")
        AsciiArt.illustrateShips(bobBoard, bobOverlay, bobOwnCursor, width, height) returns Vector(
          "XXXXXXXXXXXXX",
          "XX          XXX",
          "XX           XX",
          "XX          XXX",
          ...
          "XX          XXX",
          "XXXXXXXXXXXXX")
        AsciiArt.illustrateInfo(bobState) returns List("≈≈≈ ≈≈≈≈≈≈≈≈≈ ≈≈≈≈")
  ...
  describe("illustrateMines") {
    ...
    it("Empty grid") {
      assert(AsciiArt.illustrateMines(Map.empty, None, 3, 3) == Vector(
        "╭──┬──┬──╮",
        "├──┼──┼──┤",
        "├──┼──┼──┤",
        "╰──┴──┴──╯"))
    ...
    it("Empty grid and a cursor") {
      assert(AsciiArt.illustrateMines(Map.empty, Some(Vector(3, 2)), 4, 4) == Vector(
        "╭──┬──┬──┬──╮",
        "├──┼──┼──┼──┤",
        "├──┼──┼──┼╲╱┤",
        "├──┼──┼──┼──┤",
        "╰──┴──┴──┴──╯"))
      assert(AsciiArt.illustrateMines(Map.empty, Some(Vector(2, 1)), 5, 3) == Vector(
        "╭──┬──┬──┬──┬──╮",
        "├──┼──┼╲╱┼──┼──┤",
        "├──┼──┼──┼──┼──┤",
        "╰──┴──┴──┴──┴──╯"))
    ...
    it("Mines") {
      assert(AsciiArt.illustrateMines(Map(Vector(1, 1) -> Left(mine)), Some(Vector(3, 2)), 4, 4) == Vector(
        "╭──┬──┬──┬──╮",
        "├──┼MM┼──┼──┤",
        "├──┼──┼──┼╲╱┤",
        "├──┼──┼──┼──┤",
        "╰──┴──┴──┴──╯"))
      assert(AsciiArt.illustrateMines(Map(Vector(2, 0) -> Left(mine), Vector(0, 1) -> Left(mine), Vector(3, 2) -> Left(mine)), None, 5, 3) == Vector(
        "╭──┬──┬MM┬──┬──╮",
        "├MM┼──┼──┼──┼──┤",
        "├──┼──┼──┼MM┼──┤",
        "╰──┴──┴──┴──┴──╯"))
  ...
  describe("illustrateShips") {
    ...
    it("Healthy ships") {
      ...
      assert(AsciiArt.illustrateShips(board, None, None, 7, 9) == Vector(
        "╭───────────╮",
        "╰──┬────────┴──┬─────╮",
        "╭──┼───────────┴─────╯",
        "│  │     ╭──╮",
    ...
    it("Damaged ships and a cursor") {
      ...
      assert(AsciiArt.illustrateShips(board, Some(overlay), Some(Vector(3, 2)), 7, 9) == Vector(
        "╭───██──────╮",
        "╰──┬───██───┴──┬───██╮",
        "╭██┼──────╲╱───┴─────╯",
        "╭──╮        ╭──╮",
